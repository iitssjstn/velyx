...
export const server: Messages['server'] = {
  ...
  subtitles: {
    ...
    text: 'Met een API-sleutel van OpenSubtitles.com kan iedereen vanuit het ondertitelmenu in de speler ondertitels zoeken, in elke taal, en er met één klik een toevoegen. Opgehaalde ondertitels worden bewaard in de datamap van Velyx (je mediabestanden worden nooit gewijzigd) en zijn te gebruiken door iedereen die het bestand mag bekijken.',
    ...
    password: 'OpenSubtitles-wachtwoord',
